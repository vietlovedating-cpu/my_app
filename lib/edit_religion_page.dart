...
class EditReligionPage extends StatefulWidget {
  ...
  const EditReligionPage({
    super.key,
    required this.languageCode,
  });

  @override
  State<EditReligionPage> createState() => _EditReligionPageState();
}

class _EditReligionPageState extends State<EditReligionPage> {
  String? _selectedKey;
  ...
  Future<void> _loadCurrentData() async {
    try {
      ...
      final data = doc.data() ?? {};
      final value = (data['religion'] ?? '').toString();
    ...
    if (_selectedKey == null) {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          ...
          content: Text(
            _tr('Vui lòng chọn tôn giáo', 'Please choose religion'),
          ),
        ),
      );
      return;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        centerTitle: true,
        title: Text(
          _tr('Sửa tôn giáo', 'Edit religion'),
          style: const TextStyle(
