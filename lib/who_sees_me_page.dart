...
class WhoSeesMePage extends StatelessWidget {
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              _tr('Chưa có ai xem hồ sơ của bạn', 'No one has viewed your profile yet'),
            ...
            Text(
              _tr(
                'Tiếp tục hoạt động để hồ sơ của bạn được chú ý nhiều hơn.',
                'Stay active to get more profile views.',
              ),
              textAlign: TextAlign.center,
              style: const TextStyle(
                fontSize: 14,
