...
class EditHaveChildrenPage extends StatefulWidget {
  final String languageCode;

  const EditHaveChildrenPage({
    super.key,
    required this.languageCode,
  });

  @override
  State<EditHaveChildrenPage> createState() => _EditHaveChildrenPageState();
}

class _EditHaveChildrenPageState extends State<EditHaveChildrenPage> {
  ...
  Future<void> _loadCurrentData() async {
    try {
      ...
      final data = doc.data() ?? {};
      final value = (data['haveChildren'] ?? '').toString();
...
// Lưu thông tin con cái
await userRef.set({
  'haveChildren': _selectedValue,
