...
class LanguageExchangeGroupChatPage extends StatefulWidget {
...
final bool currentUserIsActive;
  ...
  const LanguageExchangeGroupChatPage({
  super.key,
  ...
  @override
  State<LanguageExchangeGroupChatPage> createState() => _LanguageExchangeGroupChatPageState();
}

Map<String, dynamic>? _myMembershipData;

class _LanguageExchangeGroupChatPageState extends State<LanguageExchangeGroupChatPage> {
...
String? _replyToMessageId;
  ...
  bool get _isLanguageExchangeGroup =>
      widget.group.id == 'english_exchange' ||
      widget.group.id == 'vietnamese_exchange';
...
void initState() {
  ...
  Future<void> _loadMembership() async {
    ...
    try {
      ...
      debugPrint('Load language exchange membership error: $e');
  ...
  Future<bool> _checkMembershipBeforeAction() async {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text(
          _label(
            'Bạn cần tham gia nhóm trước khi nhắn tin.',
            'Please join the group before chatting.',
          ),
        ),
      ),
    );
...
final hasReply = replyToSenderName.isNotEmpty ||
  ...
  Widget _buildJoinRequiredBanner() {
      ...
      child: Row(
        children: [
          ...
          Expanded(
            child: Text(
              _label(
                'Bạn cần tham gia nhóm miễn phí trước khi nhắn tin.',
                'Please join this free group before chatting.',
              ),
              style: const TextStyle(
                fontSize: 13.5,
                height: 1.45,
                                ...
                                child: TextField(
                                  ...
                                  decoration: InputDecoration(
                                    hintText: _hasActiveMembership
                                        ...
                                        : _label(
                                            'Tham gia nhóm để tiếp tục nhắn tin...',
                                            'Join the group to continue chatting...',
                                          ),
